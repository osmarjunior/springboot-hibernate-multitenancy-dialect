...
public class MultiTenantDialect extends Dialect {

	private static final Map<String, Dialect> DIALECTS = new HashMap<>();

	static {
		DIALECTS.put("oracle", new Oracle12cDialect());
		DIALECTS.put("mssql", new SQLServer2012Dialect());
	}

	private static Dialect getCurrentDialect() {
		Dialect dialect = DIALECTS.get(TenantContext.getContextDialect());
	...
	public String getAddForeignKeyConstraintString(String constraintName, String[] foreignKey, String referencedTable,
		...
		return getCurrentDialect().getAddForeignKeyConstraintString(constraintName, foreignKey, referencedTable,
